...
const syncPush = (dogId, kind, data) => {
  sbReq("activities", {
    method: "POST", body: JSON.stringify({ id: String(data.id), dog_id: dogId, kind, data }),
    prefer: "return=minimal", extra: { Prefer: "resolution=merge-duplicates" },
  });
};
...
export default function PawTimer() {
  ...
  // ── Cross-device sync: fetch remote on mount + poll every 30 s ────────────
  useEffect(() => {
