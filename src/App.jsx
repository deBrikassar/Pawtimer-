...
import { fmt, normalizeWalkType, walkTypeLabel } from "./features/app/helpers";
      ...
      <div className="app">
        <div className="header">
          <div className="header-top">
            ...
            <div className="header-sync" aria-live="polite">
              ...
              <div className="sync-caption">{syncSummary.detail}</div>
            </div>
          </div>
        </div>
