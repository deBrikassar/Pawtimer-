...
const styles = `
  ...
  :root {
    ...
    --type-secondary-line: 18px;
    --type-secondary-weight: 400;
    --type-secondary-track: 0;
    --type-overline-size: 11px;
    --type-overline-line: 14px;
    --type-overline-weight: 400;
    --type-overline-track: 0.04em;
    --type-metric-xl-size: 40px;
    --type-metric-xl-line: 42px;
    --type-metric-xl-weight: 700;
    --type-metric-xl-track: -0.03em;
    --type-metric-lg-size: 30px;
    --type-metric-lg-line: 34px;
    --type-metric-lg-weight: 700;
    --type-metric-lg-track: -0.025em;
    --type-button-lg-size: 18px;
  ...
  .ds-btn-primary { background:var(--brown); color:white; box-shadow:0 4px 20px rgba(75,60,48,0.25); font-weight:600; }
  ...
  .app-subtitle { font-size:var(--type-body-size); color:var(--text-muted); margin-top:1px; font-weight:var(--type-body-weight); line-height:var(--type-body-line); letter-spacing:var(--type-body-track); }
  ...
  .dog-photo-img { width:52px; height:52px; border-radius:50%; object-fit:cover; border:2.5px solid var(--green); display:block; box-shadow:0 2px 8px rgba(61,140,96,0.16); }
  .dog-photo-placeholder { width:52px; height:52px; border-radius:50%; background:var(--surf-soft); border:2px dashed var(--border); display:flex; align-items:center; justify-content:center; }
  ...
  .session-control-wrap { margin-top:18px; display:flex; justify-content:center; }
  .session-control {
  ...
  .readiness-label { font-size:12px; color:var(--text-muted); font-weight:400; }
  .readiness-value { font-size:12px; font-weight:400; letter-spacing:0.03em; }
  ...
  /* ── Stats rings card ── */
  .stats-rings-card { margin:14px 0 0; background:rgba(255,255,255,0.92); border-radius:var(--radius); padding:8px 6px 8px; box-shadow:0 2px 9px rgba(75,60,48,0.05); border:1px solid rgba(96,142,111,0.08); display:flex; position:relative; }
  ...
  /* ── Grouped tool card ── */
  .tool-group-card { margin:6px 8px 0; background:linear-gradient(160deg,#ffffff 0%, #f8fcf9 100%); border:1px solid rgba(96,142,111,0.18); border-radius:16px; box-shadow:0 10px 26px rgba(59,90,71,0.12); overflow:visible; padding:12px; }
  ...
  .proto-warn-title { font-size:var(--type-secondary-size); font-weight:400; line-height:var(--type-secondary-line); color:var(--amber); margin-bottom:4px; }
  ...
  .proto-field-input { width:64px; text-align:right; padding:5px 8px; border:1.5px solid var(--border); border-radius:8px; font-size:var(--type-body-size); font-weight:var(--type-body-weight); color:var(--brown); background:var(--surf-soft); outline:none; font-variant-numeric:tabular-nums; }
  ...
  .ring-time { font-size:20px; font-weight:400; color:var(--brown); }
  ...
  /* ── Tabs ── */
  .tabs { position:fixed; bottom:0; left:50%; transform:translateX(-50%); width:100%; max-width:480px; background:rgba(247,242,231,0.97); backdrop-filter:blur(14px); border-top:1.5px solid var(--border); display:flex; z-index:100; padding:1px 0 calc(env(safe-area-inset-bottom,0px) + 1px); }
  .tab-btn { flex:1; min-height:42px; padding:5px 4px 5px; background:none; border:none; cursor:pointer; display:flex; flex-direction:column; align-items:center; gap:3px; color:var(--color-text-subtle); transition:color 0.18s; font-size:var(--type-secondary-size); font-weight:var(--type-secondary-weight); line-height:var(--type-secondary-line); letter-spacing:var(--type-secondary-track); }
  ...
  .howto-toggle { width:100%; display:flex; justify-content:space-between; align-items:center; padding:11px 16px; background:var(--surf); border:none; font-size:var(--type-secondary-size); font-weight:var(--type-button-weight); line-height:var(--type-secondary-line); color:var(--brown); cursor:pointer; border-left:3px solid var(--green-dark); }
  ...
  .share-id-val { font-family:var(--font-ui); font-size:var(--type-section-title-size); line-height:var(--type-section-title-line); font-weight:var(--type-body-weight); color:var(--brown); letter-spacing:var(--type-overline-track); text-transform:uppercase; flex:1; font-variant-numeric:tabular-nums; }
  ...
  .diag-run-btn { border:1px solid var(--green-dark); background:transparent; color:var(--green-dark); border-radius:999px; padding:6px 12px; font-size:12px; font-weight:400; cursor:pointer; }
