              ...
              if (item.kind === "session") {
                ...
                return (
                  <div className="h-item" key={`s-${s.id}`}>
                    ...
                    <button className="h-del" onClick={() => setSessions(prev => prev.filter(x => x.id !== s.id))} title="Delete">✕</button>
                  </div>
                );
              }
              if (item.kind === "walk") {
                ...
                return (
                  <div className="h-item" key={`w-${w.id}`}>
                    ...
                    <button className="h-del" onClick={() => setWalks(prev => prev.filter(x => x.id !== w.id))} title="Delete">✕</button>
                  </div>
                );
              }
              if (item.kind === "pat") {
                ...
                return (
                  <div className="h-item" key={`p-${p.id}`}>
                    ...
                    <button className="h-del" onClick={() => setPatterns(prev => prev.filter(x => x.id !== p.id))} title="Delete">✕</button>
                  </div>
                );
              }
              return null;
