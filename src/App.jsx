...
export default function PawTimer() {
  ...
  const appContextValue = {
    ...
    totalCount: appData.totalCount, bestCalm: appData.bestCalm, latestCalm: appData.latestCalm, relapseTone: appData.relapseTone, chartData: appData.chartData, distributionData: appData.distributionData,
