...
const Img = ({ src, size = 24, alt = "" }) => (
  <img src={`/icons/${src}`} width={size} height={size} alt={alt}
...
const PawIcon = ({ size = 36 }) => (
  <img src="/icons/paw.png" width={size} height={size} alt="PawTimer"
...
export default function PawTimer() {
  ...
  // ── Handlers ─────────────────────────────────────────────────────────────
  const openDog = (dog) => {
    // Directly load all data and open the app — does NOT rely on useEffect,
    // so it works even if activeDogId is already set to this same value.
        ...
        {tab === "progress" && (
          <div className="section">
            ...
            <div className="streak-card">
              ...
              <div className="streak-lbl" style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:8 }}>
                Calm session streak <Img src="streak.png" size={28} alt="streak"/>
              </div>
            </div>
