...
export default function PawTimer() {
  ...
  const nextTargetInfo = useMemo(
    () => explainNextTarget(sessions, walks, patterns, appData.dog),
    [appData.dog, patterns, sessions, walks],
  );
